...
namespace Gelisim_Muhasebe.StokModulu
{
    ...
    {
        cls_StokKod4 StokKod = new cls_StokKod4();
        ...
        {
            frmAnamenu.SecilenKodAdi = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Kod4").ToString();
            frmAnamenu.SecilenKodID = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Kod4ID").ToString();
            Close();
        }
        ...
        private void Kaydetbtn_Click(object sender, EventArgs e)
        {
            if (Edit)
            {
                string SecilenID = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Kod4ID").ToString();
        ...
        private void frmStokKod4_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            Aciklamabox.Text = string.Empty;
            KodBox.Text = string.Empty;
            KodBox.Text = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Kod4").ToString();
            Aciklamabox.Text = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Kod4Aciklama").ToString();
        }
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                {
                    string SecilenID = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Kod4ID").ToString();
                    if (StokKod.StokKodKullanimdami(SecilenID))
                    {
        ...
        private void frmStokKod4_FormClosed(object sender, FormClosedEventArgs e)
        {
            Edit = false;
            Aciklamabox.Text = string.Empty;
            KodBox.Text = string.Empty;
