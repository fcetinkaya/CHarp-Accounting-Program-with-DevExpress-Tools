...
{
    class cls_StokKod3 : IDisposable
    {
        SqlConnection con = new SqlConnection(Yol.ECon);
        public bool StokKodKayit(string _Kod, string _Aciklama, int _saveUserID)
        {
            SqlCommand com = new SqlCommand("insert into Muhasebe_TBL_StokKodUc values(@Kod3,@Kod3Aciklama,@SaveUserID,@SaveDate,@EditUserID,@EditDate,@Kullanimda)", con);
            com.Parameters.AddWithValue("@Kod3", _Kod);
            com.Parameters.AddWithValue("@Kod3Aciklama", _Aciklama);
        ...
        {
            SqlCommand com = new SqlCommand("update Muhasebe_TBL_StokKodUc set Kod3=@Kod3,Kod3Aciklama=@Kod3Aciklama where Kod3ID=@ID", con);
            com.Parameters.AddWithValue("@Kod3", _Kod);
            com.Parameters.AddWithValue("@Kod3Aciklama", _Aciklama);
        ...
        {
            SqlCommand com = new SqlCommand("update Muhasebe_TBL_StokKodUc set Kullanimda=0,EditUserID=@UID,EditDate=@DT  where Kod3ID=@ID", con);
            com.Parameters.AddWithValue("@ID", _GelenID);
        ...
        {
            SqlCommand com = new SqlCommand("delete from Muhasebe_TBL_StokKodUc where Kod3ID=@ID", con);
            com.Parameters.AddWithValue("@ID", _GelenID);
        ...
        {
            SqlCommand com = new SqlCommand("select StokID from Muhasebe_TBL_Stoklar where Kod3=@Kod3", con);
            com.Parameters.AddWithValue("@Kod3", _GelenID);
        ...
        {
            SqlDataAdapter dap = new SqlDataAdapter("select Kod3ID,Kod3,Kod3Aciklama from Muhasebe_TBL_StokKodUc", con);
        ...
        {
            string Gidecek = "";
            SqlCommand com = new SqlCommand("select Kod3ID from Muhasebe_TBL_StokKodUc where Kod3=@Kod3 or Kod3Aciklama=@Kod3", con);
            com.Parameters.AddWithValue("@Kod3", _StokKodAdi);
            if (con.State == ConnectionState.Closed)
            {
                con.Open();
            }
            ...
            else
            {
                SqlCommand com2 =
                    new SqlCommand(
                        "insert into Muhasebe_TBL_StokKodUc values(@Kod3,@Kod3Aciklama,@SaveUserID,@SaveDate,@EditUserID,@EditDate,@Kullanimda); select scope_identity()",
                        con);
                com2.Parameters.AddWithValue("@Kod3", _StokKodAdi);
                com2.Parameters.AddWithValue("@Kod3Aciklama", _StokKodAdi);
