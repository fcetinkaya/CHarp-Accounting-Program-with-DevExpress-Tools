...
{
    class cls_SatisFaturasi : IDisposable
    {
        ...
        public int BankaHareketKayit(string _BelgeNo, string _Tarih, double _tutar, string _BankaID, int _KullaniciID, int _EvrakID)
        {
            ...
            com.Parameters.AddWithValue("@EditUserID", DBNull.Value);
            com.Parameters.AddWithValue("@EditDate", DBNull.Value);
            com.Parameters.AddWithValue("@EvrakTuru", "Satış Faturası");
        ...
        {
            SqlDataAdapter dap = new SqlDataAdapter("select Muhasebe_TBL_Cariler.CariID,Muhasebe_TBL_Cariler.CariKodu,Muhasebe_TBL_Cariler.CariIsim,Muhasebe_TBL_Faturalar.FaturaID,Muhasebe_TBL_Faturalar.FaturaNo,Muhasebe_TBL_Faturalar.BelgeNo,Muhasebe_TBL_Faturalar.Tarih,Muhasebe_TBL_Faturalar.GenelToplam,Muhasebe_TBL_Faturalar.Turu from Muhasebe_TBL_Faturalar inner join Muhasebe_TBL_Cariler on Muhasebe_TBL_Cariler.CariID=Muhasebe_TBL_Faturalar.CariID where Muhasebe_TBL_Faturalar.IsActive=1 and Muhasebe_TBL_Faturalar.TipiValue=0 order by Muhasebe_TBL_Faturalar.FaturaSayisi", con);
        ...
        {
            SqlDataAdapter dap = new SqlDataAdapter(string.Format("select Muhasebe_TBL_Cariler.CariID,Muhasebe_TBL_Cariler.CariKodu,Muhasebe_TBL_Cariler.CariIsim,Muhasebe_TBL_Faturalar.FaturaID,Muhasebe_TBL_Faturalar.FaturaNo,Muhasebe_TBL_Faturalar.BelgeNo,Muhasebe_TBL_Faturalar.Tarih,Muhasebe_TBL_Faturalar.GenelToplam,Muhasebe_TBL_Faturalar.Turu from Muhasebe_TBL_Faturalar inner join Muhasebe_TBL_Cariler on Muhasebe_TBL_Cariler.CariID=Muhasebe_TBL_Faturalar.CariID where Muhasebe_TBL_Faturalar.IsActive=1 and Muhasebe_TBL_Faturalar.TipiValue=0 {0} order by Muhasebe_TBL_Faturalar.FaturaSayisi", aranacakKelime), con);
            DataTable dt = new DataTable();
            dap.Fill(dt);
            return dt;
        }
